    ...
    try {
      ...
      if (verificationBadge) {
        ...
        if (verData.verified) {
          ...
          b.style.cssText = 'display:inline-block;background:linear-gradient(135deg,#15b37a,#0dd67f);color:#000;padding:4px 12px;border-radius:20px;font-size:0.85rem;font-weight:700;';
          b.textContent = '✓ Verified';
          verificationBadge.appendChild(b);
        } else if (verData.status === 'pending') {
          const b = document.createElement('span');
          b.className = 'verification-badge';
          b.style.cssText = 'display:inline-block;background:rgba(255,165,0,0.2);color:#ffad33;padding:4px 12px;border-radius:20px;font-size:0.85rem;font-weight:700;border:1px solid rgba(255,165,0,0.3);';
          b.textContent = '⏳ Pending Verification';
          verificationBadge.appendChild(b);
        } else {
          const b = document.createElement('span');
          b.className = 'verification-badge';
          b.style.cssText = 'display:inline-block;background:rgba(255,107,107,0.15);color:#ff6b6b;padding:4px 12px;border-radius:20px;font-size:0.85rem;font-weight:700;border:1px solid rgba(255,107,107,0.3);';
